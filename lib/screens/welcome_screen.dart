...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  bool starting = false;
  _startNow() async {
    if (pricePerCigaratte == null || dailycigarattes == null || reason.length == 0 || currency == null) return false;
    setState(() {
      starting = true;
    });
    ...
    Future.delayed(Duration(seconds: 5), () {
      ...
      pref.setDouble("pricePerCigaratte", pricePerCigaratte ?? 0);
      pref.setInt("dailycigarattes", dailycigarattes ?? 0);
    ...
    switch (i) {
      case 0:
        return Container(
          ...
          child: Column(
            children: [
              Text(langs[lang]["welcome"]["welcometext"], style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center, textScaler: TextScaler.linear(1)),
              SizedBox(height: getProportionateScreenHeight(50)),
              Text(
                langs[lang]["welcome"]["tellreason"],
                style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: getProportionateScreenWidth(22), color: Colors.black.withAlpha(150)),
              ...
              TextField(
                ...
                decoration: InputDecoration(hintText: langs[lang]["welcome"]["reasonhint"]),
              ),
              Column(
                children: [
                  TextButton(
                      ...
                      child: Text("\u{2795} ${langs[lang]["welcome"]["addtolist"]}"))
                ],
              ),
              Expanded(
          ...
          child: Column(
            children: [
              Text(
                ...
                style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: getProportionateScreenWidth(32)),
                textAlign: TextAlign.center,
              ),
              SizedBox(
        ...
        return Center(
          child: Column(
            ...
            children: [
              Snappable(
                key: snapKey,
                child: Image.asset("./assets/images/cigarette.png", width: getProportionateScreenWidth(200), height: getProportionateScreenWidth(200)),
              ),
              if (!starting)
                AvatarGlow(
  ...
  _moveToNextPage() {
    ...
    setState(() {
      if (reason.length != 0 && index == 0 || (index == 1 && !(pricePerCigaratte == null || dailycigarattes == null || currency == null))) index += 1;
    });
  }
  ...
  AnimatedContainer buildpageindicator(int i) {
    return AnimatedContainer(
      ...
      width: index == i ? 15 : 10,
      height: 10,
      decoration: BoxDecoration(color: index == i ? Colors.blue : Colors.grey, borderRadius: BorderRadius.circular(20)),
    );
  }
}
